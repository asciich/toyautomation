...
# Files for gamepad installation

## sixpair.c

* Used to connect PS3 controller.
* Downloaded using `wget http://www.pabr.org/sixlinux/sixpair.c`
* Source: https://github.com/rdepena/node-dualshock-controller/wiki/Pairing-The-Dual-shock-3-controller-in-Linux-(Ubuntu-Debian)
